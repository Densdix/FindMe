        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            // Sign in success, update UI with the signed-in user's information
                            Toast.makeText(DriverLoginActivity.this, "createUserWithEmail:success",
                            ...
                            // If sign in fails, display a message to the user.
                            Toast.makeText(DriverLoginActivity.this, "createUserWithEmail:failure",
                                    Toast.LENGTH_SHORT).show();
                            updateUI(null);
                        }
                    }
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            // Sign in success, update UI with the signed-in user's information
                            Toast.makeText(DriverLoginActivity.this, "signInWithEmail:success",
                                    Toast.LENGTH_SHORT).show();
                            FirebaseUser user = mAuth.getCurrentUser();
                            updateUI(user);
                        } else {
                            // If sign in fails, display a message to the user.
                            Toast.makeText(DriverLoginActivity.this, "signInWithEmail:failure",
                                    Toast.LENGTH_SHORT).show();
                            updateUI(null);
                        }
                    }
